<?php if(!class_exists('Rain\Tpl')){exit;}?>
      ...
      <p id="titulo-cadastro-usuario">Solicitações</p>
          ...
          <button id="filtro-cadastro-usuario" onclick="window.location.href='/sistema/filtrar-tickets-fila';">Filtro</button>
          <br><br>
      </div>
      <div id="tabelas-1">
        <table class="table table-light">
          ...
          <tbody>
            <?php $counter1=-1;  if( isset($queue) && ( is_array($queue) || $queue instanceof Traversable ) && sizeof($queue) ) foreach( $queue as $key1 => $value1 ){ $counter1++; ?>
            <tr>
